...
//
// Духовные камни — таблица фазы 4.1 (истор.: CombatLootService.GenerateNPCLoot,
// сервис удалён в R13-аудите P1-3): L1-2: 1-3 осколка; L3-4: 2-5 осколков; L5+: 1-2 фрагмента.
//
