...
| `GODOT_COMBAT_SIM=1` | CombatSimDebug | Бой в обе стороны + weapon end-to-end + readiness-gate (R21-2: Accepted/Rejected «не готов»/re-ready; R23-1: 3e (a)-(e) через DebugSetReadinessPermil — charged при 600‰ = Accepted и НЕ расходует) + r21-гарды: броня (плоское вычитание + DR-агрегат) и пассивный щит Ци (VERDICT) |
